...
Normalisierungspunkten ausschließen, d.h. löschen (breite Linien).
Der Glättungsparameter 'sm' stellt die Empfindlichkeit des Splines ein
...
def maximacalc(inter, flux, wave):
    """
    Berechnet lokale Maxima in einem Intervall
    """
...
def reduction(s1, s2, points_wave, points_flux, wave, normfunction):
    """
    Löscht Werte ober- und unterhalb der Parameter s2 und s1
    """
