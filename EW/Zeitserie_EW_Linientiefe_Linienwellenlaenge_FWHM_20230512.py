...
Zeile 83 geändert werden. Falls die grafische/interaktive Eingabe der Integrations-
...
plt.grid(True)
print('\nBitte Plot auf den Integrationsbereich interaktiv einengen')
plt.pause(20)
...
ascii.write(
    ...
    'EW_' + '{:.2f}_'.format(begin) + '{:.2f}'.format(end) + '.csv',
    names=["Spektrum ", 'JD', "EW", 'Wellenlaenge',
