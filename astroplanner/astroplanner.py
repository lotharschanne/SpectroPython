...
# -*- coding: utf-8 -*-
"""
Berechnet die Höhe des Objektes über dem Horizont für einen Zeitpunkt an einem
...
frage = input('Drücken Sie eine Taste, wenn Sie das Programm beenden möchten: ')
