...
Objektnamen in einer Spalte) über dem Horizont für einen geplanten Zeitpunkt
an einem Beobachtungsort und plottet sie über einen Zeitraum von 24 Stunden.
