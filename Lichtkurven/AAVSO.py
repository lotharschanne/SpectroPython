...
# -*- coding: utf-8 -*-
"""
Übernimmt die Lichtkurvendaten aus einer csv-Datei. Man gibt den auszuwertenden
Zeitraum ein (JD Anfang und Ende) und das programm berechnet die Tagesmittelwerte
der mag-Werte. Diese werden in eine csv geschrieben und grafisch dargestellt.
