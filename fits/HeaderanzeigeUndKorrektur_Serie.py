...
Korrektur/Ergänzung des Headers.
...
Wenn nein 0 eingeben, wenn Headereintrag eine Zahl ist: 1, wenn \
Headereintrag ein String ist: 2 : "
)
...
while Eingabe == '1' or Eingabe == '2':
    ...
    if Eingabe == "1":
        ...
        break
    Eingabe = input(
        "Weitere Headereinträge ändern? Wenn nein Eingabe von 0, Wenn ja, Eingabe von 1 oder 2: "
    )
    k += 1
