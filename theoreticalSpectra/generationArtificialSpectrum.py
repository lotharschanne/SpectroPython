...
# -*- coding: utf-8 -*-
"""
The script generates an artificial, gaussian broadened to a certain FWHM,
expressed by an R, broadened line spectrum.
...
fits.writeto('R'+str(int(R))+'_Spectrum_FWHM' + str(fwhm) + 'A.fits', r, header,
             overwrite=True, output_verify="silentfix")
fits.writeto("Spectrum_Original_withoutBroadening.fits", y, header,
             overwrite=True, output_verify="silentfix")
